const wishes = [
    ...
    "Әрқашан шаңырақтарыңыздың берекесі болып, үйіңізден жылылық кетпесін.",
    "Жанарың әрдайым нұр шашып, жүзің күндей күлімдеп, жүрегің көктемдей жайнасын!",
    "Өмірдің бар асылын, бақытын, шаттығын тілейміз!",
    ...
    "Аспаныңыз ашық, махаббатыңыз баянды, бағыңыз мәңгілік болсын!",
    "Әрбір таңыңыз шаттық пен қуанышқа толы болсын!",
    "Көктемнің жылы шуағы жүрегіңізге жылу сыйласын!",
    "Өміріңіз мәнді, көңіліңіз сәнді болсын!",
    "Еңбегіңіз жансын, мәртебеңіз биік болсын!",
    "Жұлдызыңыз жоғары болып, бақыт құсы басыңызға қонсын!"
];
